...
const required=['index.html','vercel.json','scripts/write-version.mjs','public/live-update.js','public/sw.js','public/manifest.webmanifest','src/main.jsx','src/lifepilot-v2.jsx','src/lifepilot-v2.css','src/lib/supabase.js','supabase/schema.sql']
for(const file of required) await access(file)
const index=await readFile('index.html','utf8')
const main=await readFile('src/main.jsx','utf8')
const app=await readFile('src/lifepilot-v2.jsx','utf8')
const pkg=JSON.parse(await readFile('package.json','utf8'))
if(!index.includes('/src/main.jsx')) throw new Error('V2 entrypoint is not wired')
...
if(!main.includes('lifepilot-v2')) throw new Error('V2 app is not the main entrypoint')
