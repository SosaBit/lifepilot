...
import {BarChart3,Home,Target,Zap,Trophy,Brain} from 'lucide-react';
import './gameplay.css';

const items=[['home','Home',Home],['plan','Piano',BarChart3],['goals','Obiettivi',Target],['focus','Focus',Zap],['gameplay','Gameplay',Trophy],['quiz','Quiz',Brain]];
