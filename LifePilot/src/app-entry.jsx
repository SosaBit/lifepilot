...
const AppShellRoute=()=>isAppPath?<OnboardingGate><AppShell><LifePilotV2/><MobileBottomNav/></AppShell></OnboardingGate>:<Landing/>;
...
createRoot(document.getElementById('root')).render(<AppErrorBoundary><AppShellRoute/></AppErrorBoundary>);
