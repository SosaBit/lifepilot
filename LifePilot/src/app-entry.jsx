...
import LifePilotGate from './lifepilot-gate.jsx';
import GameChrome from './game-chrome.jsx';
...
const App=()=>isAppPath?<OnboardingGate><AppShell><GameChrome/><LifePilotGate/></AppShell></OnboardingGate>:<Landing/>;
