...
export const ROUTES=Object.freeze({home:'home',plan:'plan',goals:'goals',focus:'focus',gameplay:'gameplay',quiz:'quiz',progress:'progress',notifications:'notifications',profile:'profile',coach:'coach',shop:'shop'});
